...
3. Add the environment variables from the repo root `.env` (or your Supabase project values) in Vercel Project Settings. The app reads `VITE_`-prefixed values in the browser and uses the non-prefixed equivalents on the server/runtime.
